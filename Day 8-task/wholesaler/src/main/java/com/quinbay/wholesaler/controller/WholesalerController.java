...
public class WholesalerController {
    ...
    public ResponseEntity<Wholesaler> getWholesaler(@PathVariable int wid) {
        return wholesalerService.findWholesaler(wid);
    }

    @PutMapping("/updateWholesaler/{id}/{code}")
    public String updateWholesaler(@PathVariable int id,@PathVariable int code){
        return wholesalerService.updateWholesaler(id,code);
    }
